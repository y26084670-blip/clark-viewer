...
export const QUANTITIES = Object.freeze({
  ...
  MHdot: { label: "Плотность энергии ФММ", formula: "0,4π·(M·H)", unit: "Дж/м³", file: "MH", offset: 3,
    components: 1, productOffsets: [3, 6], factor: 0.4 * Math.PI, group: "elements", solvedOnly: true, fmmOnly: true },
  ...
  JEdot: { label: "Потери на токи проводимости", formula: "J·E", unit: "Вт/мм³", file: "JE", offset: 3,
    components: 1, productOffsets: [3, 6], factor: 1e-3, group: "elements", solvedOnly: true },
